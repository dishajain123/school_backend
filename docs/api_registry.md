...
## Removed APIs (Phase 3, High Confidence)

- `DELETE /api/v1/teacher-class-subjects/{assignment_id}`
- `GET /api/v1/academic-years/{year_id}`
- `GET /api/v1/attendance/analytics/class`
- `GET /api/v1/documents/review-queue`
- `GET /api/v1/masters/grades/{grade_id}`
- `GET /api/v1/masters/standards/{standard_id}`
...
- `PATCH /api/v1/teacher-class-subjects/{assignment_id}`
- `POST /api/v1/diary/create`
- `POST /api/v1/fees/structures`
- `POST /api/v1/teacher-class-subjects`

## Deprecated APIs (Phase 2, Returning 410 Gone)

- `POST /api/v1/academic-years/{old_year_id}/rollover`
- `GET /api/v1/files/{bucket}/{file_key:path}`
- `GET /api/v1/teacher-class-subjects`
- `GET /api/v1/teacher-class-subjects/mine`
- `GET /api/v1/users`
- `POST /api/v1/users`
